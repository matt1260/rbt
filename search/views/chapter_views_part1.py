            ...
            # Old Testament books
                ...
                for i, row in enumerate(result, start=1):
                    try:
                        ...
                        interlinear += f'<a class="occurrence-icon" href="/translate/word-occurrences/?strongs={strongs}" title="View every NT occurrence" aria-label="View every NT occurrence"><i class="fas fa-list"></i></a>\n'
